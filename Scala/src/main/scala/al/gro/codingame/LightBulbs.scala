...
object LightBulbs {
    ...
    @tailrec
    private def checkAllRemainingChars(
        counter: Int,
        init: String,
        init1: String,
        last: Char): Int = {
    ...
    /**
     * private def buildNewString(input: String, indexToModify:Int,
     * newChat:Char):String ={ input.toCharArray.update(indexToModify,
     * newChat).toString }
     */
}
