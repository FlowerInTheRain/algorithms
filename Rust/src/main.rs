...
fn tournament(participants: Vec<&str>) -> HashMap<i32,String> {
...
fn equality_handling(c_or_u: char, mut winners: &mut Vec<Player>,  mut winner:&mut i32,  num_player_1: i32, num_player_2:  i32,  sign_player_1:  String,  sign_player_2:String, index_player_1:i32, index_player_2:i32) {
    if c_or_u == 'c' {
...
fn set_winner_remove_loser( winners: &mut Vec<Player>, winner:  &mut i32, round_loser: i32, index_player: i32, index_to_remove: i32) {
    let mut player: &Player = winners.get(index_player as usize).unwrap();
